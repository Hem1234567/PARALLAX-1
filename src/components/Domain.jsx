...
function Domain() {
  useEffect(() => {
    ...
    // Create an IntersectionObserver to handle the pinning effect
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            textAlignCenter.style.position = "fixed";
            textAlignCenter.style.top = "50px";
          } else {
            textAlignCenter.style.position = "absolute";
            textAlignCenter.style.top = "auto";
          }
        });
      },
      { threshold: 0.1 }
              ...
              <div className="tabs_container">
                <div className="tabs_component">
                  <div className="tabs_left">
                    <div className="tabs_left-top">
                      ...
                      <div className="tabs_let-content is-2">
                        ...
                        <div className="tabs_line"></div>
                        <p className="text-size-small text-color-gray400">
                          3 riding modes: 🌱 eco, ⚡️ normal & 🚀 boost - that
                          offer up to 80 km range on one single charge with a
                          swappable battery.
                        </p>
                      </div>
                      <div className="tabs_let-content is-3">
                        <h2 className="heading-style-h4 text-color-gray100">
                          ...
                          <span className="text-color-green">all the way</span>
                        </h2>
                        <div className="tabs_line"></div>
                        <p className="text-size-small text-color-gray400">
                          We spent years crafting Yoda, stripping away
                          unnecessary components to deliver a{" "}
                  ...
                  <div className="tabs_right">
                    <div
                      className="tabs_video is-1 w-background-video w-background-video-atom"
                      style={{
                        display: "flex",
